...
echo -e "${YW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${CL}"
echo -e "${RD}IMPORTANT: Google OAuth Configuration Required${CL}"
echo -e "${YW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${CL}\n"
echo -e "${YW}Your app is using: ${BL}http://${IP}:4000/api/auth/google/callback${CL}"
echo -e "${RD}WARNING: Google OAuth does NOT accept private IPs!${CL}\n"
echo -e "${GN}RECOMMENDED SOLUTION - Use nip.io:${CL}"
echo -e "  1. Access your app at: ${BL}http://$(echo ${IP} | tr '.' '-').nip.io:3000${CL}"
echo -e "  2. Add this redirect URI to Google Cloud Console:"
echo -e "     ${BL}http://$(echo ${IP} | tr '.' '-').nip.io:4000/api/auth/google/callback${CL}"
echo -e "  3. Update /opt/sample-solution/.env and change:"
echo -e "     ${BL}API_URL=http://$(echo ${IP} | tr '.' '-').nip.io:4000${CL}"
echo -e "     ${BL}FRONTEND_URL=http://$(echo ${IP} | tr '.' '-').nip.io:3000${CL}"
echo -e "     ${BL}GOOGLE_REDIRECT_URI=http://$(echo ${IP} | tr '.' '-').nip.io:4000/api/auth/google/callback${CL}"
echo -e "  4. Restart services: ${BL}cd /opt/sample-solution && docker compose -f docker-compose.prod.yml restart${CL}\n"
echo -e "${YW}Alternative: Use localhost with SSH port forwarding${CL}"
echo -e "  ${BL}ssh -L 3000:${IP}:3000 -L 4000:${IP}:4000 root@${IP}${CL}\n"
echo -e "${YW}For more options, see: /opt/sample-solution/.env${CL}"
